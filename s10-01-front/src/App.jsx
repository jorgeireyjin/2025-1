...
import ConsultaAsincrona from './Asincrono';
import ConsultaPromesa from './Promesa';
    ...
    <Router>
      <Routes>
        <Route path="/" element={ <Layout/> }>
            ...
            <Route path="/asincrono" element={ <ConsultaAsincrona/> } /> 
            <Route path="/promesa" element={ <ConsultaPromesa/> } />
