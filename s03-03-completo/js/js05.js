/* CASO 1: Recorrer cabecera y body */
var cabecera = document.head;
console.log(cabecera)

/* CASO 2: Recorrer cabecera y body */
var cuerpo = document.body
console.log(cuerpo)

/* CASO 3: Cada nodo tiene una propiedad nodeTye */
var lpAntiguos = document.getElementById("antiguo")
console.log(lpAntiguos)

/* CASO 4 : Cada nodo tiene una propiedad nodeTye */
var lpAntiguos = document.getElementById("antiguo")
console.log(lpAntiguos)
